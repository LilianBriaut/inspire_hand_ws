...
if __name__ == "__main__":
    ...
    process_r = multiprocessing.Process(target=worker, args=('192.168.123.210','r',"右手进程"))
    process_l = multiprocessing.Process(target=worker, args=('192.168.123.211','l',"左手进程"))
